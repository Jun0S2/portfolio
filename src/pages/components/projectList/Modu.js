...
export default function Modu() {
  ...
  const projectInfo = {
    ...
    learned: `🙆 유저 🔑 관리자  🌙/🔆테마 변경 🍞Toast UI Open Source 적용 ✔️모듈화 (게시글 리스트/작성)\n
      모두의 집 프로젝트는 공공데이터, Vue.js 와 JavaScript 를 기반으로 제작되었습니다. Vuetify를 처음으로 도입한 프로젝트이며 처음으로 오픈 소스(Toast UI Editor)를 활용한 프로젝트였습니다. 가장 기억에 남는 부분은 팀원이 사용한 각각의 v-simple-table을 활용성이 더 높은 v-data-table로 변경하고 하나의 모듈로 변경한 부분이었습니다. 또한, 유저부분의 백앤드도 맡아서 진행했습니다.
      `,
